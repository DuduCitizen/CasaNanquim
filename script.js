...
// No mobile, usamos configurações mais leves para evitar janks durante o scroll:
// - once: true  → animação dispara só uma vez, sem re-calcular na volta
// - offset menor → dispara antes, reduzindo trabalho em viewports pequenas
// - duration menor → menos frames renderizados por animação
...
// No mobile este observer é desativado: ele compete com o AOS e causa
// janks durante o scroll, pois os dois sistemas modificam opacity/transform
// ao mesmo tempo. No desktop mantém o comportamento original.
if (!isMobile) {
